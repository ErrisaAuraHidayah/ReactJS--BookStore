...
app.get("/pegawai" , (req,res) => {
    ...
    db.query(sql, (err, result) => {
        if(err) {
            ...
            // (versi lama) buat nge-set header == sama kayak res.json
            res.setHeader("Content-Type", "application/json") // (ini ketika express tidak punya res.json)
...
// PUT: /pegawai/update --> end point untuk update data pegawai
