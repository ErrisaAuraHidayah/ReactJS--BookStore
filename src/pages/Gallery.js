...
class Gallery extends Component {
    ...
    //ini untuk menghapus buku pd array
    Drop = (item) => {
        //beri konfirmasi untuk menghapus data
        if(window.confirm("Apakah Anda yakin ingin menghapus data ini?")){
            //menghapus data
            let tempBuku = this.state.buku
            //posisi index daya yg akan dihaps
        ...
        addToCart = (selectedItem) => {
            ...
            if(existItem){
                ...
                if(promptJumlah !== null && promptJumlah !== ""){
                    ...
                    //memudahkan properti "jumlahBeli" pada item yang dipilih
    ...
    // menampilkan data buku yang tersimpan pada array
render() {
    return (
